...
namespace BasicLib.Forms.Base{
	public static class FormUtil{
		private static readonly Color[] predefinedColors = new[]{
			Color.Blue, Color.FromArgb(255, 144, 144), Color.Green, Color.FromArgb(255, 0, 255), Color.FromArgb(168, 156, 82),
			Color.LightBlue, Color.Orange, Color.Cyan, Color.Pink, Color.Turquoise, Color.LightGreen, Color.Brown,
			Color.DarkGoldenrod, Color.DeepPink, Color.LightSkyBlue
		};
