...
namespace BasicLib.Mol{
	public class ChemElement{
		...
		private ChemElement(int z, string symbol, string name, double[] masses, double[] composition, double atomicWeight,
			ChemElementType type, bool isotopicLabel = false){
			Symbol = symbol;
			this.masses = masses;
			Z = z;
			Name = name;
		...
		private static ChemElement[] InitElements(){
			ChemElement[] e = new[]{
				...
				new ChemElement(1, "D", "", new[]{1.0078250321, 2.014101778}, new[]{0.0, 100.0}, 2.014101778,
					ChemElementType.Nonmetal, true),
				new ChemElement(1, "T", "", new[]{1.0078250321, 2.014101778, 3.0160492777}, new[]{0.0, 0.0, 100.0}, 3.0160492777,
					ChemElementType.Nonmetal, true),
				new ChemElement(2, "He", "", new[]{3.0160293191, 4.00260325415}, new[]{0.000134, 99.999866}, 4.002602,
					ChemElementType.NobleGas),
				new ChemElement(3, "Li", "", new[]{6.0151223, 7.0160040}, new[]{7.59, 92.41}, 6.941, ChemElementType.AlkaliMetal),
				new ChemElement(5, "B", "", new[]{10.0129370, 11.0093055}, new[]{19.9, 80.1}, 10.811, ChemElementType.Semimetal),
				new ChemElement(4, "Be", "", new[]{9.0121822}, new[]{100.0}, 9.0121822, ChemElementType.AlkalineEarth),
				new ChemElement(6, "C", "", new[]{12.0, 13.0033548378}, new[]{98.93, 1.07}, 12.0107, ChemElementType.Nonmetal),
				new ChemElement(6, "Cx", "", new[]{12.0, 13.0033548378}, new[]{0.0, 100.0}, 13.0033548378, ChemElementType.Nonmetal,
					true),
				new ChemElement(7, "N", "", new[]{14.0030740052, 15.0001088984}, new[]{99.632, 0.368}, 14.0067,
					ChemElementType.Nonmetal),
				new ChemElement(7, "Nx", "", new[]{14.0030740052, 15.0001088984}, new[]{0.0, 100.0}, 15.0001088984,
					ChemElementType.Nonmetal, true),
				new ChemElement(8, "O", "", new[]{15.9949146221, 16.9991315, 17.9991604}, new[]{99.757, 0.038, 0.205}, 15.9994,
					ChemElementType.Nonmetal),
				new ChemElement(8, "Ox", "", new[]{15.9949146221, 17.9991604}, new[]{0.0, 100.0}, 17.9991604,
					ChemElementType.Nonmetal, true),
				new ChemElement(9, "F", "", new[]{18.99840320}, new[]{100.0}, 18.9984032, ChemElementType.Halogen),
				new ChemElement(10, "Ne", "", new[]{19.9924401754, 20.99384668, 21.991385114}, new[]{90.48, 0.27, 9.25}, 20.1797,
					ChemElementType.NobleGas),
				new ChemElement(11, "Na", "", new[]{22.98976967}, new[]{100.0}, 22.989770, ChemElementType.AlkaliMetal),
				new ChemElement(12, "Mg", "", new[]{23.985041700, 24.98583692, 25.982592929}, new[]{78.99, 10.00, 11.01}, 24.3050,
					ChemElementType.AlkalineEarth),
				new ChemElement(13, "Al", "", new[]{26.98153863}, new[]{100.0}, 26.98153863, ChemElementType.BasicMetal),
				new ChemElement(15, "P", "", new[]{30.97376151}, new[]{100.0}, 30.973761, ChemElementType.Nonmetal),
				...
				new ChemElement(17, "Cl", "", new[]{34.96885271, 36.9659026}, new[]{75.78, 24.22}, 35.453, ChemElementType.Halogen),
				...
				new ChemElement(19, "Kx", "", new[]{38.9637069, 39.96399867, 40.96182597}, new[]{0.0, 0.0, 100.0}, 40.96182597,
					ChemElementType.AlkaliMetal, true),
				new ChemElement(21, "Sc", "", new[]{44.9559119}, new[]{100.0}, 44.9559119, ChemElementType.TransitionMetal),
				new ChemElement(22, "Ti", "", new[]{45.9526316, 46.9517631, 47.9479463, 48.9478700, 49.9447912},
					new[]{8.25, 7.44, 73.72, 5.41, 5.18}, 47.867, ChemElementType.TransitionMetal),
				new ChemElement(20, "Ca", "", new[]{39.9625912, 41.9586183, 42.9587668, 43.9554811, 45.9536928, 47.952534},
					new[]{96.941, 0.647, 0.135, 2.086, 0.004, 0.187}, 40.078, ChemElementType.AlkalineEarth),
				new ChemElement(23, "V", "", new[]{49.9471585, 50.9439595}, new[]{0.250, 99.750}, 50.9415,
					ChemElementType.TransitionMetal),
				new ChemElement(24, "Cr", "", new[]{49.9460442, 51.9405075, 52.9406494, 53.9388804},
					new[]{4.345, 83.789, 9.501, 2.365}, 51.9961, ChemElementType.TransitionMetal),
				...
				new ChemElement(27, "Co", "", new[]{58.9331950}, new[]{100.0}, 58.933195, ChemElementType.TransitionMetal),
				...
				new ChemElement(30, "Zn", "", new[]{63.9291466, 65.9260368, 66.9271309, 67.9248476, 69.9253250},
					new[]{48.63, 27.90, 4.10, 18.75, 0.62}, 65.409, ChemElementType.TransitionMetal),
				...
				new ChemElement(32, "Ge", "", new[]{69.9242474, 71.9220758, 72.9234589, 73.9211778, 75.9214026},
					new[]{20.38, 27.31, 7.76, 36.72, 7.83}, 72.64, ChemElementType.Semimetal),
				new ChemElement(33, "As", "", new[]{74.9215964}, new[]{100.0}, 74.92160, ChemElementType.Semimetal),
				new ChemElement(34, "Se", "", new[]{73.9224766, 75.9192141, 76.9199146, 77.9173095, 79.9165218, 81.9167000},
					new[]{0.89, 9.37, 7.63, 23.77, 49.61, 8.73}, 78.96, ChemElementType.Nonmetal),
				new ChemElement(35, "Br", "", new[]{78.9183376, 80.916291}, new[]{50.69, 49.31}, 79.904, ChemElementType.Halogen),
				new ChemElement(36, "Kr", "", new[]{77.9203648, 79.9163790, 81.9134836, 82.914136, 83.911507, 85.91061073},
					new[]{0.355, 2.286, 11.593, 11.500, 56.987, 17.279}, 83.798, ChemElementType.NobleGas),
				...
				new ChemElement(38, "Sr", "", new[]{83.913425, 85.9092602, 86.9088771, 87.9056121}, new[]{0.56, 9.86, 7.00, 82.58},
					87.62, ChemElementType.AlkalineEarth),
				new ChemElement(39, "Y", "", new[]{88.9058483}, new[]{100.0}, 88.9058483, ChemElementType.TransitionMetal),
				new ChemElement(40, "Zr", "", new[]{89.9047044, 90.9056458, 91.9050408, 93.9063152, 95.9082734},
					new[]{51.45, 11.22, 17.15, 17.38, 2.80}, 91.224, ChemElementType.TransitionMetal),
				new ChemElement(41, "Nb", "", new[]{92.9063781}, new[]{100.0}, 92.90638, ChemElementType.TransitionMetal),
				new ChemElement(45, "Rh", "", new[]{102.905504}, new[]{100.0}, 102.905504, ChemElementType.TransitionMetal),
				...
				new ChemElement(43, "Tc", "", new[]{98.9062547}, new[]{100.0}, 98.9062547, ChemElementType.TransitionMetal),
				...
				new ChemElement(48, "Cd", "",
					...
					new[]{1.25, 0.89, 12.49, 12.80, 24.13, 12.22, 28.73, 7.49}, 112.411, ChemElementType.TransitionMetal),
				...
				new ChemElement(50, "Sn", "",
					...
					ChemElementType.BasicMetal),
				new ChemElement(53, "I", "", new[]{126.904468}, new[]{100.0}, 126.90447, ChemElementType.Halogen),
				new ChemElement(49, "In", "", new[]{112.904058, 114.903878}, new[]{4.29, 95.71}, 114.818, ChemElementType.BasicMetal)
				,
				...
				new ChemElement(57, "La", "", new[]{137.907112, 138.9063533}, new[]{0.09, 99.91}, 138.90547,
					ChemElementType.Lanthanide),
				new ChemElement(58, "Ce", "", new[]{135.907172, 137.905991, 139.9054387, 141.909244},
					new[]{0.185, 0.251, 88.450, 11.114}, 140.116, ChemElementType.Lanthanide),
				...
				new ChemElement(55, "Cs", "", new[]{132.905451933}, new[]{100.0}, 132.905451933, ChemElementType.AlkaliMetal),
				new ChemElement(59, "Pr", "", new[]{140.9076528}, new[]{100.0}, 140.90765, ChemElementType.Lanthanide),
				new ChemElement(60, "Nd", "",
					new[]{141.9077233, 142.9098143, 143.9100873, 144.9125736, 145.9131169, 147.916893, 149.920891},
					new[]{27.2, 12.2, 23.8, 8.3, 17.2, 5.7, 5.6}, 144.242, ChemElementType.Lanthanide),
				new ChemElement(61, "Pm", "", new[]{144.912749}, new[]{100.0}, 144.912749, ChemElementType.Lanthanide),
				...
				new ChemElement(62, "Sm", "",
					...
					new[]{3.07, 14.99, 11.24, 13.82, 7.38, 26.75, 22.75}, 150.36, ChemElementType.Lanthanide),
				new ChemElement(64, "Gd", "",
					new[]{151.9197910, 153.9208656, 154.9226220, 155.9221227, 156.9239601, 157.9241039, 159.9270541},
					new[]{0.20, 2.18, 14.80, 20.47, 15.65, 24.84, 21.86}, 157.25, ChemElementType.Lanthanide),
				new ChemElement(65, "Tb", "", new[]{158.9253468}, new[]{100.0}, 158.92535, ChemElementType.Lanthanide),
				...
				new ChemElement(67, "Ho", "", new[]{164.9303221}, new[]{100.0}, 164.93032, ChemElementType.Lanthanide),
				new ChemElement(68, "Er", "", new[]{161.928778, 163.929200, 165.9302931, 166.9320482, 167.9323702, 169.9354643},
					new[]{0.139, 1.601, 33.503, 22.869, 26.978, 14.910}, 167.259, ChemElementType.Lanthanide),
				new ChemElement(69, "Tm", "", new[]{168.9342133}, new[]{100.0}, 168.93421, ChemElementType.Lanthanide),
				...
				new ChemElement(72, "Hf", "", new[]{173.940046, 175.9414086, 176.9432207, 177.9436988, 178.9458161, 179.9465500},
					new[]{0.16, 5.26, 18.60, 27.28, 13.62, 35.08}, 178.49, ChemElementType.TransitionMetal),
				...
				new ChemElement(74, "W", "", new[]{179.946704, 181.9482042, 182.9502230, 183.9509312, 185.9543641},
					new[]{0.12, 26.50, 14.31, 30.64, 28.43}, 183.84, ChemElementType.TransitionMetal),
				...
				new ChemElement(79, "Au", "", new[]{196.966552}, new[]{100.0}, 196.96655, ChemElementType.TransitionMetal),
				...
				new ChemElement(82, "Pb", "", new[]{203.9730436, 205.9744653, 206.9758969, 207.9766521},
					new[]{1.4, 24.1, 22.1, 52.4}, 207.2, ChemElementType.BasicMetal),
				new ChemElement(81, "Tl", "", new[]{202.9723442, 204.9744275}, new[]{29.52, 70.48}, 204.3833,
					ChemElementType.BasicMetal),
				new ChemElement(83, "Bi", "", new[]{208.9803987}, new[]{100.0}, 208.98040, ChemElementType.BasicMetal),
				new ChemElement(84, "Po", "", new[]{208.9824304}, new[]{100.0}, 208.9824304, ChemElementType.Semimetal),
				new ChemElement(85, "At", "", new[]{209.987148}, new[]{100.0}, 209.987148, ChemElementType.Halogen),
				new ChemElement(86, "Rn", "", new[]{222.0175777}, new[]{100.0}, 222.0175777, ChemElementType.NobleGas),
				new ChemElement(87, "Fr", "", new[]{223.0197359}, new[]{100.0}, 223.0197359, ChemElementType.AlkaliMetal),
				new ChemElement(88, "Ra", "", new[]{226.0254098}, new[]{100.0}, 226.0254098, ChemElementType.AlkalineEarth),
				new ChemElement(89, "Ac", "", new[]{227.0277521}, new[]{100.0}, 227.0277521, ChemElementType.Actinide),
				new ChemElement(90, "Th", "", new[]{232.0380553}, new[]{100.0}, 232.0380553, ChemElementType.Actinide),
				new ChemElement(91, "Pa", "", new[]{231.0358840}, new[]{100.0}, 231.0358840, ChemElementType.Actinide),
				new ChemElement(92, "U", "", new[]{234.0409521, 235.0439299, 238.0507882}, new[]{0.0054, 0.7204, 99.2742}, 238.02891,
					ChemElementType.Actinide),
				new ChemElement(93, "Np", "", new[]{237.0481734}, new[]{100.0}, 237.0481734, ChemElementType.Actinide),
				new ChemElement(94, "Pu", "", new[]{244.064204}, new[]{100.0}, 244.064204, ChemElementType.Actinide),
				new ChemElement(95, "Am", "", new[]{243.0613811}, new[]{100.0}, 243.0613811, ChemElementType.Actinide),
				new ChemElement(96, "Cm", "", new[]{247.070354}, new[]{100.0}, 247.070354, ChemElementType.Actinide),
				new ChemElement(97, "Bk", "", new[]{247.070307}, new[]{100.0}, 247.070307, ChemElementType.Actinide),
				new ChemElement(98, "Cf", "", new[]{251.079587}, new[]{100.0}, 251.079587, ChemElementType.Actinide),
				new ChemElement(99, "Es", "", new[]{252.082980}, new[]{100.0}, 252.082980, ChemElementType.Actinide),
				new ChemElement(100, "Fm", "", new[]{257.095105}, new[]{100.0}, 257.095105, ChemElementType.Actinide),
				new ChemElement(101, "Md", "", new[]{258.098431}, new[]{100.0}, 258.098431, ChemElementType.Actinide),
				new ChemElement(102, "No", "", new[]{259.10103}, new[]{100.0}, 259.10103, ChemElementType.Actinide),
				new ChemElement(103, "Lr", "", new[]{262.10963}, new[]{100.0}, 262.10963, ChemElementType.Actinide),
				new ChemElement(104, "Rf", "", new[]{265.11670}, new[]{100.0}, 265.11670, ChemElementType.TransitionMetal),
				new ChemElement(105, "Db", "", new[]{268.12545}, new[]{100.0}, 268.12545, ChemElementType.TransitionMetal),
				new ChemElement(106, "Sg", "", new[]{271.13347}, new[]{100.0}, 271.13347, ChemElementType.TransitionMetal),
				new ChemElement(107, "Bh", "", new[]{272.13803}, new[]{100.0}, 272.13803, ChemElementType.TransitionMetal),
				new ChemElement(108, "Hs", "", new[]{270.13465}, new[]{100.0}, 270.13465, ChemElementType.TransitionMetal),
				new ChemElement(109, "Mt", "", new[]{276.15116}, new[]{100.0}, 276.15116, ChemElementType.TransitionMetal),
				new ChemElement(110, "Ds", "", new[]{281.16206}, new[]{100.0}, 281.16206, ChemElementType.TransitionMetal),
				new ChemElement(111, "Rg", "", new[]{280.16447}, new[]{100.0}, 280.16447, ChemElementType.TransitionMetal),
				new ChemElement(112, "Cn", "", new[]{285.17411}, new[]{100.0}, 285.17411, ChemElementType.TransitionMetal)
			};
