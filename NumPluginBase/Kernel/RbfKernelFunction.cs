...
namespace NumPluginBase.Kernel{
	...
	public class RbfKernelFunction : IKernelFunction{
		...
		public Parameters Parameters { get { return new Parameters(new DoubleParam("Sigma", Sigma) { Help = "Standard deviation parameter." }); } set { Sigma = value.GetParam<double>("Sigma").Value; } }
