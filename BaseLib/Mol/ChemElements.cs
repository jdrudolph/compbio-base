		...
		private static ChemElement[] InitElements(){
			ChemElement[] e = new[]{
				...
				new ChemElement(14, "Si", "Silicon", new[]{27.9769265325, 28.976494700, 29.97377017}, new[]{92.223, 4.685, 3.092},
					28.0855, ChemElementType.Semimetal),
				...
				new ChemElement(38, "Sr", "Strontium", new[]{83.913425, 85.9092602, 86.9088771, 87.9056121},
					new[]{0.56, 9.86, 7.00, 82.58}, 87.62, ChemElementType.AlkalineEarth, "7440-24-6"),
				...
				new ChemElement(42, "Mo", "Molybdenum",
					...
					new[]{14.84, 9.25, 15.92, 16.68, 9.55, 24.13, 9.63}, 95.94, ChemElementType.TransitionMetal, "7439-98-7"),
				...
				new ChemElement(44, "Ru", "Ruthenium",
					...
					new[]{5.54, 1.87, 12.76, 12.60, 17.06, 31.55, 18.62}, 101.07, ChemElementType.TransitionMetal, "7440-18-8"),
				...
				new ChemElement(52, "Te", "Tellurium",
					...
					new[]{0.09, 2.55, 0.89, 4.74, 7.07, 18.84, 31.74, 34.08}, 127.60, ChemElementType.Semimetal, "13494-80-9"),
