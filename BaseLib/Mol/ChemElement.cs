	...
	public class ChemElement{
		...
		private static ChemElement[] InitElements(){
			ChemElement[] e = new[]{
				...
				new ChemElement(3, "Li", "Lithium", new[]{6.0151223, 7.0160040}, new[]{7.59, 92.41}, 6.941, ChemElementType.AlkaliMetal),
				...
				new ChemElement(12, "Mg", "Magnesium", new[]{23.985041700, 24.98583692, 25.982592929}, new[]{78.99, 10.00, 11.01}, 24.3050,
				...
				new ChemElement(18, "Ar", "", new[]{35.967545106, 37.9627324, 39.9623831225}, new[]{0.3365, 0.0632, 99.6003}, 39.948,
					ChemElementType.NobleGas),
				new ChemElement(19, "K", "Potassium", new[]{38.9637069, 39.96399867, 40.96182597}, new[]{93.2581, 0.0117, 6.7302}, 39.0983,
