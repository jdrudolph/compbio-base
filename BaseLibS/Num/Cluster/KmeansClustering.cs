...
namespace BaseLibS.Num.Cluster
{
    public class KmeansClustering
    {
        ...
        public static void GenerateClusters(MatrixIndexer data, int k, int maxIter, int restarts, Action<int> progress, out float[,] clusterCenters,
            out int[] clusterIndices)
        {
        ...
        private static void RestoreRowIndices(Dictionary<EquatableArray<double>, List<int>> rowIndexMap, int[] uniqueClusterIndices, int[] clusterIndices)
        {
        ...
        private static void ExtractUniqueRows(MatrixIndexer data, out Dictionary<EquatableArray<double>, List<int>> rowIndexMap, out double[][] reducedData)
        {
        ...
        public static void GenerateClustersImpl(double[][] data, int k, int maxIter, int restarts, Action<int> progress, out float[,] clusterCenters,
            out int[] clusterIndices)
        {
        ...
        private static double[,] SelectCenter(double[][] xy, int npoints, int nvars, double[,] centers, bool[] busycenters, int k)
        {
